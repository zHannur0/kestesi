...
const NewsCard: FC<IProps> = ({ item }) => {
  return (
    <div className={"w-[1720px] min-h-[320px] bg-white flex rounded-[20px] cursor-pointer"}>
      <div
      ...
      <div
        className={
          "flex w-[1160px] flex-col gap-[20px] py-[20px] pl-[23px] px-[35px]"
        }
      >
        ...
        <div className={"text-[20px] text-[#7B7984]"}>{item.date}</div>
      </div>
    </div>
  );
};
