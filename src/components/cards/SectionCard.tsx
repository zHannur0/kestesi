    ...
    <div className={"w-full min-h-[320px] bg-white flex rounded-[20px] max-sm:flex-col"}>
      ...
      <div
        className={"flex w-[1160px] flex-col gap-[20px] py-[25px] px-[20px]" +
            " max-sm:w-full max-sm:p-[20px] max-sm:gap-[10px]"}
      >
        <div
          className={"text-[32px] font-bold leading-[136.687%] text-[#524FA2] max-sm:text-lg"}
        >
          {section.kruzhok_name}
        </div>
        <div className={"text-2xl font-medium leading-[23px] tracking-[0.5px] max-sm:text-[14px]"}>
