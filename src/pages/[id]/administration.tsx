    ...
    return (
        <MainLayout isMain={false} link={t.administration.toSchoolPassport} handleClick={handleBack} page={`/${id}/administration`} bg={"bg3"}>
            ...
            <div className={"flex flex-col bg-white rounded-[40px] w-[100%] max-h-[900px] max-sm:rounded-[20px] vr:max-h-[1600px]"}>
                <div className={"flex gap-[50px] py-[46px] px-[50px] bg-[#F8F8FB] rounded-t-[40px] max-sm:rounded-t-[20px] w-[100%] h-[362px] items-center max-sm:h-auto" +
                    ...
                    <div className={"flex flex-col gap-[20px] max-sm:gap-[10px] vr:gap-[40px]"}>
                        <div className={"flex flex-col"}>
                            <div
                                className={"text-[30px] leading-[50px] font-bold text-[#524FA2] max-sm:text-2xl vr:text-[50px] vr:leading-normal"}>
                                {director?.[0]?.director_name}
                            </div>
                            <div
                                className={"text-[24px] leading-[20px] text-[#211F23] max-sm:text-lg vr:text-[40px] vr:leading-normal"}>
                ...
                <div
                    className={"flex flex-col px-[35px] py-[50px] w-full gap-[30px] overflow-auto scrollbar-hide max-sm:p-[20px]"}>
                    ...
                    <div
                        className={"flex flex-wrap gap-[50px] max-sm:flex-col max-sm:flex-nowrap max-sm:w-full vr:flex-col vr:flex-nowrap vr:w-full"}>
                        {
